...
```bash
composer require toxy-tech/assets
```
...
'providers' => [
    ...
    ToxyTech\Assets\Providers\AssetsServiceProvider::class,
];
```
...
'aliases' => [
    ...
    'Assets' => ToxyTech\Assets\Facades\AssetsFacade::class,
];
```
...
```bash
php artisan vendor:publish --provider="ToxyTech\Assets\Providers\AssetsServiceProvider" --tag=config
```
